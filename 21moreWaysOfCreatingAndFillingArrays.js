...
const x = new Array(7); // Array will create array of size 7, it will be a empty array 
console.log(x);
// empty array + fill
x.fill(1,3,5); // it will fill the empty array with 1 from index 3 to 5
console.log(x);
x.fill(1);// it will fill the empty array 1 on all index 
console.log(x);
...
//------------How to get data from user interface-----------------
labelBalance.addEventListener('click', function () {
    ...
    // document.querySelectorAll('.movements__value'), isko karne ka 
    // 2nd way 
